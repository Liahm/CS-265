...
public class Operator extends Token {
	...
	protected int getPrec()
	{
    	...
    	//Had if(val == opType.ADD || so on, not sure if that was
		//correct
    	String opType = val.getName();
      if(opType.equals("+") || opType.equals("-"))
	      return 1;//precedence of rank 1
	   else if(opType.equals("*") || opType.equals("/") || opType.equals("%"))
			return 2; //precedence of rank 2
      return 0; //precedence of rank 0, in this case the '('.
	}
